...
function OnlineStreamingEvents() {
    ...
    useEffect(() => {
        async function getMovies() {
            try {
                const response = await axios.get('http://localhost:5000/bookmyshow/onlineStream/get');
    ...
    return (
        <div style={{ backgroundColor:"rgb(245, 245, 245)",padding: "2% 9% 1.5% 9%" }}>

            <h2 style={{fontSize:"1.7rem", fontWeight:"bold"}}>Online Streaming Events</h2>
